...
public class CustomPageDrawerNew extends PageDrawer
{
    ...
    private static class MyPageDrawer extends PageDrawer
    {
        ...
        {
        	LOG.debug("GLYPH "+textRenderingMatrix+" / "+font+" / "+code+" / "+unicode+" / "+displacement);
            // draw glyph
        ...
        {
        	LOG.debug("fillPaint "+windingRule);
            // bbox in user units
...
//            restoreGraphicsState();
        ...
        private final PDFRenderer renderer = null;
        
        private final boolean subsamplingAllowed = false;
...
//            drawGlyph2D(glyph2D, font, code, displacement, at);
         ...
         * 
         * ***WARN - this does no compile/link
         * 
         * 
...
//        }
        ...
        {
            return getPaint(getGraphicsState().getStrokingColor());
