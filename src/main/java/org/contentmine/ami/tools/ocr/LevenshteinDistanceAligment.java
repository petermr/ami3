...
public class LevenshteinDistanceAligment<E> {
    ...
    public static LevenshteinDistanceAligment<Character> createAlignment(String s1, String s2) {
    	LevenshteinDistanceAligment<Character> alignment = new LevenshteinDistanceAligment<>(str2chararray(s1), str2chararray(s2));
    	return alignment;
	}
