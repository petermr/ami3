...
public class SubstitutionEditor {
	...
	private static final String ITALIC_GARBLES_XML = NAConstants.IMAGES_RESOURCE + "/" + "ocr/italicGarbles.xml";
	private static final String SUBSTITUTIONS_XML  = NAConstants.IMAGES_RESOURCE + "/" + "ocr/universalSubstitutions.xml";
