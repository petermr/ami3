...
import org.contentmine.norma.pubstyle.bmc.BmcReader;
import org.contentmine.norma.pubstyle.hindawi.HindawiReader;
import org.contentmine.norma.pubstyle.plosone.PlosoneReader;
...
public class Pubstyle {
	...
	public final static Pubstyle HINDAWI = new Pubstyle(
			"hindawi", 
			NAConstants.MAIN_NORMA_DIR+"/"+"document/hindawi/",
			new HindawiReader());
	public final static Pubstyle PLOSONE = new Pubstyle(
			"plosone",
			NAConstants.MAIN_NORMA_DIR+"/"+"document/plosone/",
			new PlosoneReader());
