...
"resource": {
  ...
  "tags":[{
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cdiv id=\"owInviteSnippet\" style=\"position:fixed;right:20px;bottom:20px;width:280px;padding:20px;margin:0;border-radius:6px;background:#333333;color:#EEEEEE;text-align:left;z-index:2200000000;opacity:0;transition:opacity 500ms;-webkit-transition:opacity 500ms;display:none;\"\u003E\u003Cdiv id=\"owInviteMessage\" style=\"padding:0;margin:0 0 20px 0;font-size:16px;\"\u003EGot a spare 5 minutes to help us improve our website?\u003C\/div\u003E\u003Ca id=\"owInviteOk\" href=\"https:\/\/8u0875za.optimalworkshop.com\/treejack\/m5m51058-0-0-0-0-0-0-0-0-0?tag=intercept\u0026amp;utm_medium=intercept\" onclick=\"this.parentNode.style.display=\u0026quot;none\u0026quot;;\" target=\"_blank\" style=\"color:#7DB6EE;font-size:16px;font-weight:bold;text-decoration:underline;\"\u003EI\u0026#39;ll do it\u003C\/a\u003E\u003Ca id=\"owInviteCancel\" href=\"javascript:void(0)\" onclick=\"this.parentNode.style.display=\u0026quot;none\u0026quot;;\" style=\"color:#EEEEEE;font-size:14px;text-decoration:underline;float:right;\"\u003ENo thanks\u003C\/a\u003E\u003C\/div\u003E\u003Cscript type=\"text\/gtmscript\"\u003Evar owOnload=function(){if(-1==document.cookie.indexOf(\"ow-intercept-treejack-22pjm76l\")){var a=new XMLHttpRequest;a.onloadend=function(){try{var c=document.getElementById(\"owInviteSnippet\"),b=new Date;b.setMonth(b.getMonth()+1);this.response\u0026\u0026!0===JSON.parse(this.response).active\u0026\u0026(document.cookie=\"ow-intercept-treejack-22pjm76l\\x3dDone;path\\x3d\/;expires\\x3d\"+b.toUTCString()+\";\",setTimeout(function(){c.style.display=\"block\";c.style.opacity=1},2E3))}catch(d){}};a.open(\"POST\",\"https:\/\/app.optimalworkshop.com\/survey_status\/treejack\/22pjm76l\/active\");\na.send()}};window.addEventListener?window.addEventListener(\"load\",function(){owOnload()}):window.attachEvent\u0026\u0026window.attachEvent(\"onload\",function(){owOnload()});\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":170
...
return null},Cd=!1;if(I.querySelectorAll)try{var Dd=I.querySelectorAll(":root");Dd&&1==Dd.length&&Dd[0]==I.documentElement&&(Cd=!0)}catch(a){}var zd=Cd;var Rd={},Q=null,Sd=Math.random();Rd.C="GTM-56FZ7G";Rd.Vb="8q1";Rd.Nh="";var Td={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Ud="www.googletagmanager.com/gtm.js";
var Vd=Ud,Wd=null,Xd=null,Yd="//www.googletagmanager.com/a?id="+Rd.C+"&cv=71",Zd={},$d={},ae=function(){var a=Q.sequence||1;Q.sequence=a+1;return a};
...
Z.a.ga=["google"],function(){var a,b,c=function(d){function e(M){var K=[].slice.call(arguments,0);K[0]=v+K[0];q.push(K)}function f(M,K){void 0!==d[K]&&e(M,d[K])}function h(M,K){void 0!==d[K]&&e(M,Number(d[K]))}function k(M,K){if(t(K))for(var O=0;O<K.length;O++)e(M,K[O])}function l(M,K,O){if(t(K))for(var T=0;T<K.length;T++){for(var S=[M],ra=K[T],sa=0;sa<O.length;sa++)S.push(ra[O[sa]]);e.apply(this,S)}}function p(M,K){void 0!==d[K]&&e("_set",M,d[K])}function n(M,K){return void 0===K?K:M(K)}function r(M,
K){void 0!==K&&(w+="&"+M+"="+K)}var t=ya,q=X("_gaq",[],!1),u=!1,v="";void 0==d.vtp_trackerName?v="gtm"+ae()+".":""!==d.vtp_trackerName&&(v=d.vtp_trackerName+".");f("_setAccount","vtp_webPropertyId");e("_set","gtmid",gi(!0));f("_setDomainName","vtp_domainName");
...
if(""!==w){var z=function(M,K,O){for(var T=K.length-1;0<=T;T--){var S=K[T].split("=");if(S[0]===M)return S[1]||"1"}for(var ra=O.length-1;0<=ra;ra--){var sa=O[ra].split("=");if(sa[0]===M)return sa[1]||"1"}},x=Re(Kl()),A=Pe(x,"query").split("&"),B=d.vtp_allowAnchor?Pe(x,"fragment").split("&"):[];r("gclid",z("gclid",B,A));r("gclsrc",z("gclsrc",B,A));r("dclid",z("dclid",B,A));e("_set","campaignParams",w)}p("anonymizeIp","vtp_anonymizeIp");
...
var ma=function(){X("_gat")||d.vtp_gtmOnFailure()};if(d.vtp_doubleClick)b||(b=!0,W(V("https","http","://stats.g.doubleclick.net/dc.js",u),ma,d.vtp_gtmOnFailure));else if(!a){var aa=d.vtp_useDebugVersion?".google-analytics.com/u/ga_debug.js":".google-analytics.com/ga.js";a=!0;W(V("https://ssl","http://www",aa,u),ma,d.vtp_gtmOnFailure)}};Z.__ga=c;Z.__ga.b="ga";Z.__ga.g=!0;Z.__ga.priorityOverride=0}();
