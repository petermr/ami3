...
import org.contentmine.norma.editor.Substitution;
...
public class SubstitutionEditorTest {
	...
	public void testCorrectNonMatchingStrings() throws FileNotFoundException {
		...
		substitutionEditor.addEditor(new FileInputStream(new File(NAConstants.TEST_NORMA_DIR, "editor/speciesEditor.xml")));
		Element mixedOtus = XMLUtil.parseQuietlyToDocument(new File(NAConstants.TEST_NORMA_DIR, "editor/mixedOtus.xml")).getRootElement();
