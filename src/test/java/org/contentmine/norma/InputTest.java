...
public class InputTest {
	...
	public void testInputSingleFile() {
		...
		Assert.assertEquals("input file", NormaFixtures.TEST_NORMA_DIR+"/"+"miscfiles/pensoft-4478.xml", inputList.get(0));
	}
	...
	public void testInputSeveralFiles() {
		...
		Assert.assertEquals("input file", NormaFixtures.TEST_NORMA_DIR+"/"+"miscfiles/pensoft-4478.xml", inputList.get(2));
	}
	...
	public void testInputDirectory() {
		...
		Assert.assertTrue("input file", inputList.contains(NormaFixtures.TEST_NORMA_DIR+"/"+"miscfiles/numbered/nlm1.xml"));
	...
	public void testMakeSingleQuickscrape() {
		...
		List<String> inputList = argProcessor.getInputList();
		Assert.assertEquals("inputList", 1, inputList.size());
		Assert.assertEquals("input file", NormaFixtures.TEST_NORMA_DIR+"/"+"miscfiles/mdpi-04-00932.xml", inputList.get(0));
		CTreeList cTreeList = argProcessor.getCTreeList();
		Assert.assertNotNull(cTreeList);
	...
	public void testMakeMultipleCTree() {
		...
		Assert.assertEquals("inputList", 3, inputList.size());
		Assert.assertEquals("input file", NormaFixtures.TEST_NORMA_DIR+"/"+"miscfiles/mdpi-04-00932.xml", inputList.get(0));
		Assert.assertEquals("input file", NormaFixtures.TEST_NORMA_DIR+"/"+"miscfiles/peerj-727.xml", inputList.get(1));
		Assert.assertEquals("input file", NormaFixtures.TEST_NORMA_DIR+"/"+"miscfiles/pensoft-4478.xml", inputList.get(2));
		argProcessor.runAndOutput();
		CTreeList cTreeList = argProcessor.getCTreeList();
	...
	public void testWildcards() {
		...
		LOG.trace(inputList);
		Assert.assertEquals("inputList", 3, inputList.size());
		Assert.assertEquals("input file", NormaFixtures.TEST_NORMA_DIR+"/"+"miscfiles/numbered/nlm2.xml", inputList.get(0));
		Assert.assertEquals("input file", NormaFixtures.TEST_NORMA_DIR+"/"+"miscfiles/numbered/nlm4.xml", inputList.get(2));
	}
	...
	public void testWildcards1() {
		...
		List<String> inputList = argProcessor.getInputList();
		Assert.assertEquals("inputList", 1, inputList.size());
		Assert.assertEquals("input file", NormaFixtures.TEST_NORMA_DIR+"/"+"miscfiles/numbered/nlm{2:4}.xml", inputList.get(0));
	}
	...
	public void testXMLSuffix() {
		String args = 
			"-i "+NormaFixtures.TEST_NORMA_DIR+"/"+"pubstyle/plosone/plos10/e0119090.xml"+
			" -o target/plos10/";
	...
	public void testSeveralXMLTransform() {
		...
		args = 
				"-i"
				+ " "+NormaFixtures.TEST_NORMA_DIR+"/"+"pubstyle/plosone/plos10/e0115544.xml"
				+ " "+NormaFixtures.TEST_NORMA_DIR+"/"+"pubstyle/plosone/plos10/e0116215.xml"
				+" -o target/plos10/";
		norma = new Norma();
		norma.run(args);
...
//		norma.run(args);
	...
	public void testRecursiveTransform() {
		...
		args = 
				"-i"
				+ " "+NormaFixtures.TEST_NORMA_DIR+"/"+"pubstyle/plosone/plos10/"
				+" -o target/plos10/"
				+ " -r true"
				+ " -e xml"
				+ ""
	...
	public void testNXMLSuffixAndScholarlyHTML() {
		String args = 
			"-i "+NormaFixtures.TEST_NORMA_DIR+"/"+"pubstyle/plosone/plos10/PLoS_One_2015_Mar_6_10(3)_e0119090.nxml"+
			" -o target/plos10/";
		Norma norma = new Norma();
		norma.run(args);
	}
